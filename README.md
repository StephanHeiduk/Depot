[README.md](https://github.com/user-attachments/files/30426213/README.md)
...
verhindert, dass Überzeugung heimlich in die Ordergröße rutscht.
...
Kostenvorschauen vor, ohne dass es zum Kauf kam. Eine Idee bis zur Ordermaske zu
verfolgen und sie dann liegen zu lassen, gehört dazu.

**Kosten werden mitgezählt.** Jede Order kostet eine feste Pauschale, unabhängig
vom Volumen — und bei einer Haltedauer von drei Monaten fällt sie zweimal an,
beim Kauf und beim Verkauf. Bei kurzen Haltedauern ist das kein Rundungsfehler,
